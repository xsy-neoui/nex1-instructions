...
1. 下载插件。
   ...
   **方式二**：
   ...
   4. 在**开发工具**标签页，找到**新版NEX开发插件1.0**，单击下载图标进行下载。
      ![](../images/newNex10Dev_environmentPreparation1.png)

2. 安装插件。
   1. 解压下载的文件。
   2. 打开 Chrome 浏览器，并进入到扩展程序页面。
      ![](../images/newNex10Dev_environmentPreparation2.png)
   3. 在**扩展程序**页面，打开**开发者模式**。
      ![](../images/newNex10Dev_environmentPreparation3.png)
   4. 单击**加载已解压的扩展程序**，选择解压的文件夹即可安装。
   安装成功后，Neo Extension DevTools 会显示在**扩展程序**页面。

   ![](../images/newNex10Dev_environmentPreparation4.png)
